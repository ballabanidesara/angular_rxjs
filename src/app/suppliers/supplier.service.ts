...
import { throwError, Observable, of, map, tap, concatMap, mergeMap, switchMap, shareReplay, catchError, combineLatest } from 'rxjs';
...
export class SupplierService {
  ...
  constructor(private http: HttpClient) {
    ...
    // this.suppliersWithSwitchMap$.subscribe(item => console.log('mergeMap result', item));
